...
userQueries.duplicateEmailCheckQuery = "SELECT users.user_id, users.firstName, users.email, user_roles.role_name as role FROM users JOIN user_roles USING (role_id) WHERE email = $1";
